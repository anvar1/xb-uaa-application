package uz.almsoft.uaa.repository;

import uz.almsoft.uaa.XbUaaApplicationApp;
import uz.almsoft.uaa.config.Constants;
import uz.almsoft.uaa.config.audit.AuditEventConverter;
import uz.almsoft.uaa.domain.PersistentAuditEvent;
...
import static uz.almsoft.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
